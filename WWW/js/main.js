$(document).ready(function () {
    ...
    $(".navbar-toggler").click(() => {
        // method 1 (safer)
        const state = $(".navbar-collapse").hasClass("show");
        if (!state) {
            $(".progression").addClass("op0")
        }
        else {
            $(".progression").removeClass("op0")
        }

        // method 2
        // $(".progression").toggleClass("op0")
    })
    ...
    $(window).on('scroll', function () {
        ...
        if (scrollY > 10) {
            ...
            //     $('.navbar-collapse').addClass('fill_nav');
            // }
            $('.navbar').addClass('fill_nav');
            $(".navbar-toggler").removeClass('color_w')
        }
        else {
            // if (window.innerWidth < 992) {
            //     $('.navbar-collapse').removeClass('fill_nav');
            // }
            $('.navbar').removeClass('fill_nav');
            $(".navbar-toggler").addClass('color_w')
        }
        // hori
